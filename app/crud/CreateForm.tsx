...
import { X, User, Mail, Shield, Activity, Loader2, Check, Zap, Crown, Edit, Users, Eye } from "lucide-react";
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[200] pt-16 md:pt-8"
        onClick={onClose}
      >
        <motion.div
          initial={{
        ...
        >
          ...
          <div className="flex-shrink-0 p-6 pb-4 border-b border-gray-700/30">
            <div className="flex items-center justify-between">
              ...
              >
                <X size={20} className="text-gray-400 group-hover:text-red-400 transition-colors duration-300" />
                {/* Pulse effect on hover */}
                <motion.div className="absolute inset-0 rounded-lg bg-red-500/0 group-hover:bg-red-500/10" initial={false} whileHover={{ scale: 1.2 }} transition={{ duration: 0.3 }} />
              </motion.button>
            </div>
          </div>
                ...
                <div className="lg:w-2/5 space-y-6">
                  ...
                  <div className="bg-blue-900/10 rounded-xl p-5 border border-blue-500/20">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-blue-300 mb-1">Quick Tips</h4>
                        <div className="space-y-1 text-xs text-gray-400">
                          <p>• Fill in all required fields</p>
                          <p>• Email must be valid format</p>
                          <p>• Role determines user permissions</p>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        >
                          ...
                          {formData.role === option.value && (
                            <motion.div
                              ...
                              className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg"
                            >
                              <Check size={12} />
                            </motion.div>
                          )}
                      ...
                      {[
                        {
                          ...
                          borderColor: "border-emerald-500/30",
                          description: "User account will be active immediately",
                        },
                        {
                          value: "inactive",
                          label: "Inactive",
                          ...
                          description: "User account will be created as inactive",
                        },
                      ].map((status) => (
                        <motion.button
                          key={status.value}
                            ...
                            <div className="flex items-center justify-between mb-1">
                              ...
                              {formData.status === status.value && (
                                <motion.div
                                  ...
                                  animate={{ scale: 1 }}
                                  transition={{ type: "spring", stiffness: 400 }}
                                  className="w-5 h-5 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center ml-2"
                                >
                                  <Check size={10} />
                                </motion.div>
                              )}
          ...
          <div className="flex-shrink-0 p-4 pt-3 border-t border-gray-700/30">
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-gray-500">
              ...
              <div className="text-gray-400">Creating new user account</div>
            </div>
          </div>
        </motion.div>
      </motion.div>
